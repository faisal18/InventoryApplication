<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SparePartList.aspx.cs" Inherits="InventoryApplication.UI_Component.Inventory.SparePart.SparePartList" %>
            ...
            <asp:GridView ID="GV_ListTickets" CssClass="table  table-hover table-bordered  pagination-ys" runat="server" CellPadding="10" CellSpacing="5"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Invoice Number">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="hyp_TicketNumber" Text='<%# Eval("InvoiceNumber") %>' NavigateUrl='<%# Eval("Id", "~/UI_Component/Inventory/SparePart/SparePartView.aspx?RecordID={0}")%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
