...
{
    public partial class TyreList : System.Web.UI.Page
    {
        ...
        public DataTable GetData()
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Tyre.GetAll().Where(x => x.DomainCompanyId == int.Parse(Session["DomainCompanyId"].ToString())).ToList());
        ...
        private DataTable GetSearchResults(string category, string search_query)
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Tyre.GetAll().Where(x => x.DomainCompanyId == DomainCompanyId).ToList());
