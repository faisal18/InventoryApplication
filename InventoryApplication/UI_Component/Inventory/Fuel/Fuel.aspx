<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Fuel.aspx.cs" Inherits="InventoryApplication.UI_Component.Inventory.Fuel.Fuel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    <div class="jumbotron">
        <h3>Inventory Fuel</h3>
