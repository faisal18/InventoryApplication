...
{
    public partial class FuelList : System.Web.UI.Page
    {
        ...
        public DataTable GetData()
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Fuel.GetAll().Where(x => x.DomainCompanyId == int.Parse(Session["DomainCompanyId"].ToString())).ToList());
        ...
        public DataTable MergeTable(DataTable dt_Main, DataTable dt_Domain)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                dt.Columns.Add("GallonsPurchased", typeof(string));
                ...
                var result = from t1 in dt_Main.AsEnumerable()
                             ...
                             select dt.LoadDataRow(new object[]
                             {
                                ...
                                t1.Field<string>("GallonsPurchased"),
        ...
        private DataTable GetSearchResults(string category, string search_query)
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Fuel.GetAll().Where(x => x.DomainCompanyId == DomainCompanyId).ToList());
