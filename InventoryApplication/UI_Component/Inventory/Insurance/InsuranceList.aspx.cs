...
namespace InventoryApplication.UI_Component.Inventory.Insurance
{
    public partial class InsuranceList : System.Web.UI.Page
    {
        ...
        public  DataTable GetData()
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Insurance.GetAll().Where(x => x.DomainCompanyId == int.Parse(Session["DomainCompanyId"].ToString())).ToList());
                dt_Domain = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpDomainCompany.GetAll().Where(x => x.Id == DomainCompanyId).ToList());
        ...
        private DataTable MergeTable(DataTable dt_Main, DataTable dt_Domain)
        {
            ...
            try
            {
                ...
                dt.Columns.Add("InsuranceStartDate", typeof(DateTime));
                dt.Columns.Add("InsuranceExpiryDate", typeof(DateTime));
                ...
                var result = from t1 in dt_Main.AsEnumerable()
                             ...
                             select dt.LoadDataRow(new object[]
                             {
                                ...
                                t1.Field<string>("Insurer"),
                                t1.Field<string>("PolicyNumber"),
                                t1.Field<string>("InsuranceCompany"),
                                t1.Field<DateTime>("InsuranceStartDate"),
                                t1.Field<DateTime>("InsuranceExpiryDate"),
        ...
        private DataTable GetSearchResults(string category, string search_query)
        {
            ...
            try
            {
                dt = DAL.Helper.ListToDatatable.ToDataTable(DAL.Operations.OpPurchase_Insurance.GetAll());
