<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsuranceEdit.aspx.cs" Inherits="InventoryApplication.UI_Component.Inventory.Insurance.InsuranceEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(function () {
            $("[id$=txt_InsuranceStartDate]").datepicker({
                //showOn: 'button',
        ...
        $(function () {
            $("[id$=txt_InsuranceExpiryDate]").datepicker({
                //showOn: 'button',
                buttonImageOnly: true,
                changeMonth: true,
                dateFormat: "yy-mm-dd",
    ...
    <asp:TableCell>
        <asp:DropDownList runat="server" ID="ddl_CreditStaus">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:DropDownList runat="server" ID="txt_InsuranceTypeId" AppendDataBoundItems="true">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txt_Insurer"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txt_PolicyNumber"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txt_InsuranceCompany"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txt_InsuranceStartDate"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txt_InsuranceExpiryDate"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
