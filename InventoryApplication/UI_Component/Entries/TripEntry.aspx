<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TripEntry.aspx.cs" Inherits="InventoryApplication.UI_Component.Entries.TripEntry" %>
        ...
        <asp:GridView runat="server" ID="GV_One"
            ...
            <Columns>
                 ...
                 <asp:TemplateField HeaderText="Invoice Number">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("InvoiceNumber") %>' runat="server"></asp:Label>
                    </ItemTemplate>
                     <EditItemTemplate>
                        <asp:TextBox ID="txt_InvoiceNumber" Text='<%# Eval("InvoiceNumber") %>' runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txt_InvoiceNumberFooter" runat="server"></asp:TextBox>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="ClientId">
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="txt_ClientId" runat="server" AutoPostBack="true" OnSelectedIndexChanged="txt_ClientId_SelectedIndexChanged"></asp:DropDownList>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:DropDownList ID="txt_ClientIdFooter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="txt_ClientIdFooter_SelectedIndexChanged"></asp:DropDownList>
                    </FooterTemplate>
                </asp:TemplateField>
...
<ItemTemplate>
    <asp:Label Text='<%# Eval("Ports") %>' runat="server"></asp:Label>
</ItemTemplate>
<EditItemTemplate>
    <asp:TextBox ID="txt_Ports" Text='<%# Eval("Ports") %>' runat="server"></asp:TextBox>
</EditItemTemplate>
<FooterTemplate>
    <asp:TextBox ID="txt_PortsFooter" runat="server"></asp:TextBox>
</FooterTemplate>
</asp:TemplateField>
...
<EditItemTemplate>
    <asp:TextBox ID="txt_RoadPermission" Text='<%# Eval("RoadPermission") %>' runat="server"></asp:TextBox>
</EditItemTemplate>
<FooterTemplate>
    <asp:TextBox ID="txt_RoadPermissionFooter" runat="server"></asp:TextBox>
</FooterTemplate>
</asp:TemplateField>
...
<EditItemTemplate>
    <asp:TextBox ID="txt_LoadingPermission" Text='<%# Eval("LoadingPermission") %>' runat="server"></asp:TextBox>
</EditItemTemplate>
<FooterTemplate>
    <asp:TextBox ID="txt_LoadingPermissionFooter" runat="server"></asp:TextBox>
</FooterTemplate>
</asp:TemplateField>--%>
                ...
                <asp:TemplateField HeaderText="Credit Status">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("CreditStatus") %>' runat="server"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:DropDownList ID="txt_CreditStatus"  runat="server"></asp:DropDownList>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:DropDownList ID="txt_CreditStatusFooter" runat="server"></asp:DropDownList>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="DriverId">
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="txt_DriverId"  runat="server"></asp:DropDownList>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:DropDownList ID="txt_DriverIdFooter" runat="server"></asp:DropDownList>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="CarId">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("CarPlateNumber") %>' runat="server"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:DropDownList ID="txt_CarId"  runat="server"></asp:DropDownList>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:DropDownList ID="txt_CarIdFooter" runat="server"></asp:DropDownList>
                    </FooterTemplate>
                </asp:TemplateField>
