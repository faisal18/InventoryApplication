...
namespace InventoryApplication.UI_Component.Reports.Sales
{
    public partial class SalesReport : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            try
            {
                ddl_domaincompany.DataSource = DAL.Operations.OpClientInformation.GetAll().Where(x => x.DomainCompanyId == DomainCompanyId).ToList();
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "Trip":
                        UI_Component.Entries.TripEntry obj = new UI_Component.Entries.TripEntry();
                ...
                {
                    dt = dt.AsEnumerable().Where(x => x.Field<string>("ClientName") == ddl_domaincompany.SelectedItem.Text).ToList().CopyToDataTable();
                    ProcessData(dt);
