<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesReport.aspx.cs" Inherits="InventoryApplication.UI_Component.Reports.Sales.SalesReport" %>
    ...
    <div class="jumbotron" style="overflow: auto">
        ...
        <asp:Table runat="server" CssClass="table" Width="100%">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:DropDownList runat="server" id="ddl_reporttype">
                        <asp:ListItem Value="Trip">Trip</asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow runat="server" ID="div_domain">
                <asp:TableCell>
                    <asp:Label runat="server" Text="Client Company"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
